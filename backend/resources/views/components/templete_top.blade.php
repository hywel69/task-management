...
<head>
	...
	<script src="{{url('/')}}/assets/js/plugins/visualization/c3/c3.min.js"></script>
	<script src="{{url('/')}}/assets/js/plugins/visualization/d3/d3_tooltip.js"></script>
	<script src="{{url('/')}}/assets/js/plugins/visualization/d3/venn.js"></script>
	<script src="{{url('/')}}/assets/js/plugins/visualization/echarts/echarts.min.js"></script>
	<script src="{{url('/')}}/assets/js/plugins/visualization/loader.js"></script>
	...
	<!-- Custom Css & Js -->
	<script src="{{url('/')}}/assets/js/plugins/editors/summernote/summernote.min.js"></script>
	<script src="{{url('/')}}/assets/js/plugins/extensions/cookie.js"></script>
	<script src="{{url('/')}}/assets/js/custom.js"></script>
	<link href="{{url('/')}}/assets/css/custom.css" rel="stylesheet" type="text/css">

	<script src="{{url('/')}}/assets/js/demo_pages/extension_dnd.js"></script>
	<script src="{{url('/')}}/assets/js/plugins/ui/dragula.min.js"></script>
	<!-- /Custom Template v2 -->
	<style>
		#diag {
			width: auto;
...
<body>
	<!-- Loader -->
	<div class="praloader" id="praloader">
		<div class="loading">
			<div class="text-center">
			<img src="{{url('/')}}/loading.gif" width="300" style="border-radius: 10px;">
			</div>
		</div>
	</div>
	<!-- Main navbar -->
	<div class="navbar navbar-expand-md nav-theme navbar-dark" style="padding-left: 10px;">
		<div class="media">
			<div class="mr-1 ml-1 mt-1 mb-1">
				<!-- <img src="{{$data['logo'] ?? ''}}" width="30"> -->
				<img src="{{url('/')}}/iconoms.png" width="30">
			</div>
			<div class="navbar-brand wmin-200" style="padding-left: 10px; padding-top: 2px;padding-bottom: 2px;">
	...
	<!-- Secondary navbar -->
	<div class="navbar navbar-expand-md navbar-light navbar-sticky breadcrumb-line breadcrumb-line-light header-elements-md-inline sidebar-theme">
		<div class="d-flex">
			<div class="breadcrumb">
				<a href="{{url('/')}}/" class="breadcrumb-item"><i class="icon-home4 mr-2"></i> Home</a>
				<span class="breadcrumb-item active sidebar-theme">{{$data['page_active'] ?? ''??''}}</span>
			</div>
	...
	<div class="page-content pt-0">
		...
		<div class="sidebar sidebar-light sidebar-main sidebar-fixed sidebar-expand-md ">
			...
			<!-- Sidebar content -->
			<div class="sidebar-content nav-theme navbar-dark">
				<div class="card card-sidebar-mobile">
					...
					<div class="card-body p-0">
						<ul class="nav nav-sidebar" data-nav-type="accordion">
							...
							<li class="nav-item">
								<a href="{{url('/')}}" class="nav-link"><i class="icon-display4"></i> <span>Dashboard</span></a>
							</li>
							<!-- Main -->
							<!-- /Main -->
