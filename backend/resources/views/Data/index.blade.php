    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          @elseif($dataform['type']=='cb')
          <div class="col-sm-{{$dataform['col'] ?? 12}}">
            <div class="form-group">
              <label class="form-label"><b>{{$dataform['label']}}</b></label>
              <input type="checkbox" class="form-control" id="{{$dataform['field']}}" name="{{$dataform['field']}}">
              <small class="form-text text-muted">{{$dataform['keterangan']}}</small>
            </div>
          </div>
          ...
          <div class="form-group">
            <input type="hidden" class="form-control" value="{{$dataform['value'] ?? ''}}" id="{{$dataform['field']}}" name="{{$dataform['field']}}" placeholder="{{$dataform['placeholder']}}">
          </div>
          ...
          <div class="col-sm-{{$dataform['col'] ?? 12}}">
            <div class="form-group">
              <label class="form-label"><b>{{$dataform['label']}}</b></label>
              <input type="file" class="form-control-uniform" id="{{$dataform['field']}}" name="{{$dataform['field']}}" placeholder="{{$dataform['placeholder']}}" onchange="convert64(this)">
          ...
          @elseif($dataform['type']=='textarea1')
          <div class="col-sm-{{$dataform['col'] ?? 12}}">
            <div class="form-group">
              <label class="form-label"><b>{{$dataform['label']}}</b></label>
              <textarea class="form-control" id="{{$dataform['field']}}" name="{{$dataform['field']}}" cols="20" rows="3" placeholder="{{$dataform['placeholder']}}" {{$dataform['disable']}}></textarea>
              <small class="form-text text-muted">{{$dataform['keterangan']}}</small>
            </div>
          </div>
          ...
          <!-- ---------------summernote----------------------- -->
          @elseif($dataform['type']=='summernote_basic')
          <div class="col-sm-{{$dataform['col'] ?? 12}}">
            <div class="form-group">
              <div class="summernote-height">
                <label class="form-label"><b>{{$dataform['label']}}</b></label>
                <textarea name="{{$dataform['field']}}" id="{{$dataform['field']}}" class="{{$dataform['field']}} form-control" cols="30" rows="3" required><span id="{{$dataform['span']}}"></span></textarea>
                <small class="form-text text-muted">{{$dataform['keterangan']}}</small>
                <script type="text/javascript">
                  $(".{{$dataform['field']}}").summernote({
          ...
          @elseif($dataform['type']=='summernote_advance')
          <div class="col-sm-{{$dataform['col'] ?? 12}}">
            <div class="form-group">
              <div class="summernote-height">
                <label class="form-label"><b>{{$dataform['label']}}</b></label>
                <textarea name="{{$dataform['field']}}" id="{{$dataform['field']}}" class="{{$dataform['field']}} form-control" cols="30" rows="10" required></textarea>
        ...
        <div class="text-right">
          <button type="submit" id="formsubmit" name="formsubmit" class="btn btn-sm btn-primary" onclick="save()"><i class="icon-floppy-disk"> </i> Save</button>
        </div>
        <!-- </form> -->
      </div>
    </div>
...
<script type="text/javascript">
  function save() {
    alertify.success('Harap tunggu, data sedang diproses.');
  ...
  function saveNew(primaryKey) {
    ...
    // -------------------------- alert -----------------------
    @if(count($listdata) > 0)
    alertify.error('Data Sudah Diinputkan -> Silahkan edit data yang sudah ada');
    @else
    $.ajax({
      type: "POST",
      headers: {
