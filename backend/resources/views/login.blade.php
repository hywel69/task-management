...
<!-- navbar-inverse -->
	<!-- Main navbar -->
	<div class="navbar navbar-expand-md navbar-dark" style="padding-left: 10px;">  
		<div class="media">
			...
			<div class="navbar-brand wmin-200" style="padding-left: 10px; padding-top: 2px;padding-bottom: 2px;">
				<div class="media-body">
					<a class="d-inline-block" href="/" style="font-size: 13px; color: white; padding: 0px;"><span style="font-weight:bold;">Logi</span></a>
				</div>
